...
sub createfiles {
 ...
 my $queuefile = "/usr/share/nashriddler/retroactive/files_recover/Queue_Statistics_" . "$ano" . "_" . "$hora" . "_" . "$minuto" . ".csv";
 my $agentfile = "/usr/share/nashriddler/retroactive/files_recover/Agent_Statistics_" . "$ano" . "_" . "$hora" . "_" . "$minuto" . ".csv";
 my $agentqueuefile = "/usr/share/nashriddler/retroactive/files_recover/AgentQueue_Statistics_" . "$ano" . "_" . "$hora" . "_" . "$minuto" . ".csv";
 ...
 while (@hole = $queuedb->fetchrow_array) {
  print FILE "15;" .$hole[5]. ";" .$hole[6] . ":" . $hole[7] .";" .$hole[2]. ";" .$hole[3]. ";" .$hole[8] . ";" . $hole[13] . ";" . $hole[11] . ";" . $hole[14] . ";" . $hole[12] . ";" . $hole[10] . ";" . $hole[9] . ";" . $hole[26] . ";" . $hole[17] . ";" . $hole[18] . ";" .$hole[19] . ";" .$hole[22] . ";" .$hole[23] . ";" .$hole[24] . ";" .$hole[27] . ";" .$hole[28] . "\n";
 }
 close FILE;
 ...
 while (@asshole = $agentdb->fetchrow_array) {
  ...
  print FILE "15;" . $asshole[4]. ";" .$asshole[5]. ":" . $asshole[6] . ";" .$asshole[2]. ";" .$asshole[3]. ";" .$asshole[7]. ";" .$asshole[9]. ";" .$asshole[10]. ";" .$asshole[13]. ";" .$asshole[12]. ";" .$asshole[14]. ";" .$asshole[15]. ";" .$asshole[16]. ";" .$asshole[17]. "\n";
 }
 close FILE;
 ...
 while (@myhole = $agqueue->fetchrow_array) {
  ...
  print FILE "15;" . $myhole[2]. ";" .$myhole[3]. ":" . $myhole[4] . ";" .$myhole[5]. ";" .$myhole[6]. ";" .$myhole[7]. ";" .$myhole[8]. ";" .$myhole[9]. ";" .$myhole[11]. ";" .$myhole[12]. ";" .$myhole[13] . "\n";
 }
